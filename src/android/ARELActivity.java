...
import  com.pomelodesign.cordova.metaio.MetaioCordovaWebView;
...
public class ARELActivity extends ARViewActivity
{
	 ...
	 */
	protected MetaioCordovaWebView mWebView;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		// create AREL WebView
		mWebView = new MetaioCordovaWebView((Context) MetaioPlugin.getPlugin().cordova);
	...
	protected void onResume()
	{
		...
		// Fire document event
		mWebView.loadUrl("javascript:cordova.fireDocumentEvent('metaioopen')");
		...
		try
		{
			...
			if (result)
			{
				if (!saveToGalleryWithoutDialog)
				{
					...
					intent.putExtra(Intent.EXTRA_STREAM, Uri.fromFile(new File(cacheDirPath, filename)));
